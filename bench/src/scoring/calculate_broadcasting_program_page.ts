...
export async function calculateBroadcastingProgramPage({ baseUrl, playwrightPage, puppeteerPage }: Params) {
  ...
  consola.debug('BroadcastingProgram - navigate');
  ...
  consola.debug('BroadcastingProgram - navigate end');
  const {
    steps: [result],
